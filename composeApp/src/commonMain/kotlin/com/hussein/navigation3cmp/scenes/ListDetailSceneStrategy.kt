package com.hussein.navigation3cmp.scenes
...
fun <T:Any> rememberListDetailSceneStrategy() : ListDetailSceneStrategy<T> {
    val widowSizeClass = currentWindowAdaptiveInfo().windowSizeClass

    return remember (widowSizeClass){
        ListDetailSceneStrategy(widowSizeClass)
    }
}